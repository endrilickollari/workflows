...
export const userRoutes = new Elysia({ prefix: "/admin/users" })
  ...
  .get(
    ...
    async ({ params: { id }, verifyAdmin }) => {
      ...
      return await userController.getUserById(parseInt(id));
    },
    {
      params: t.Object({
  ...
  .put(
    ...
    async ({ params: { id }, body, verifyAdmin }) => {
      ...
      return await userController.updateUser(parseInt(id), body);
    },
    {
      params: t.Object({
        id: t.String({ description: "User ID" }),
  ...
  .delete(
    ...
    async ({ params: { id }, verifyAdmin }) => {
      ...
      return await userController.deleteUser(parseInt(id));
    },
    {
      params: t.Object({
        id: t.String({ description: "User ID" }),
